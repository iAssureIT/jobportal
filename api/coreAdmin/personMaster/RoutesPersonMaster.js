...
router.post('/post/selectedPerson',personMaster.postlistPersons);

router.post('/post/selectedOnePerson',personMaster.postOnePersons);

router.post('/get/list',personMaster.listPersons);
 
router.post('/get/list/users',personMaster.listPersonswithusedetails);
...
router.patch('/patch/document/', personMaster.update_driver_document_satus);

router.patch('/patch/changeStatus', personMaster.updatePersonStatus);

router.patch('/patch/changeStatusProfile', personMaster.updatePersonProfileStatus);
...
router.get('/get/employeeCount/:status/:company',personMaster.countEmployeesByStatus);

router.get('/get/inactiveemployeeCount/:status/:company',personMaster.inactiveemployeeCount);

router.patch('/patch/notification_token',personMaster.notification_token);
...
router.get('/get/companyDriverCount/:company',personMaster.companyDriverCount);
