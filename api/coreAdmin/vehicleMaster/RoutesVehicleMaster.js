...
router.get('/countCompanyVehicles/:company_Id', vehicleMaster.countCompanyVehicles);
...
router.patch('/patch/document/', vehicleMaster.update_vehicle_document_status);

router.patch('/patch/changeStatus', vehicleMaster.updateVehicleStatus);
