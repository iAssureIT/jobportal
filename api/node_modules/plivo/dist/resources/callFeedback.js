...
exports.CallFeedbackInterface = exports.CallFeedback = undefined;
...
var CallFeedbackInterface = exports.CallFeedbackInterface = function (_PlivoResourceInterfa) {
    ...
    _createClass(CallFeedbackInterface, [{
        ...
        value: function create(callUUID, rating) {
            ...
            var errors = (0, _common.validate)([{ field: 'callUUId', value: callUUID, validators: ['isRequired'] }, { field: 'rating', value: rating, validators: ['isRequired'] }]);
            ...
            return _get(CallFeedbackInterface.prototype.__proto__ || Object.getPrototypeOf(CallFeedbackInterface.prototype), 'create', this).call(this, params);
        }
    }]);
