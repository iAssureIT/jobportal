...
exports.PowerpackInterface = exports.Tollfree = exports.Shortcode = exports.Numbers = exports.NumberPool = exports.Powerpack = undefined;
...
var Powerpack = exports.Powerpack = function (_PlivoResource) {
	...
	_createClass(Powerpack, [{
		...
		value: function list_numbers(params) {
			...
			return _get(Powerpack.prototype.__proto__ || Object.getPrototypeOf(Powerpack.prototype), 'customexecuteAction', this).call(this, path.toString().trim(), 'GET', queryparams);
		}
	}, {
		key: 'search_query',
		...
		value: function find_number(number) {
			...
			return _get(Powerpack.prototype.__proto__ || Object.getPrototypeOf(Powerpack.prototype), 'customexecuteAction', this).call(this, path.toString().trim(), 'GET');
		}
	}, {
		key: 'add_number',
		value: function add_number(number) {
			...
			params['rent'] = 'false';
			var path = 'NumberPool/' + this.number_pool_id + '/Number/' + number + '/';
			return _get(Powerpack.prototype.__proto__ || Object.getPrototypeOf(Powerpack.prototype), 'customexecuteAction', this).call(this, path.toString().trim(), 'POST', params);
		}
	}, {
		key: 'add_tollfree',
		...
		value: function remove_shortcode(shortcode) {
			...
			return _get(Powerpack.prototype.__proto__ || Object.getPrototypeOf(Powerpack.prototype), 'customexecuteAction', this).call(this, path.toString().trim(), 'DELETE');
		}
	}, {
		key: 'list_shortcodes',
		value: function list_shortcodes(params) {
			...
			return _get(Powerpack.prototype.__proto__ || Object.getPrototypeOf(Powerpack.prototype), 'customexecuteAction', this).call(this, path.toString().trim(), 'GET', params);
		}
	}, {
		key: 'list_tollfree',
   ...
   */
    ...
    */
		...
		value: function create(name) {
			...
			return _get(PowerpackInterface.prototype.__proto__ || Object.getPrototypeOf(PowerpackInterface.prototype), 'create', this).call(this, params);
		}
