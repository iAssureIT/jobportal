...
export default class AlldiscountedProducts extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <View style={styles.formWrapper}>
              <View>
                <View style={styles.proddets}>
                  { !this.state.loading ?
                   this.state.discountedProducts && this.state.discountedProducts.length > 0  ?
                      this.state.discountedProducts.map((item, i) => {
