...
class NewBookings extends ValidationComponent {
    constructor(props) {
        ...
        this.state = {
            imgarr: [
                { source: "https://images.pexels.com/photos/116675/pexels-photo-116675.jpeg?cs=srgb&dl=car-vehicle-automobile-range-rover-116675.jpg&fm=jpg", title: "Honda city", capacity: "4 + 1",rs: '14',createdAt: new Date() },
                { source: "https://images.pexels.com/photos/1381816/pexels-photo-1381816.jpeg?cs=srgb&dl=white-and-black-mini-cooper-1381816.jpg&fm=jpg", title: "Hyundai Elantra", capacity: "3 + 1 ",rs: '16',createdAt: new Date() },
                { source: "https://images.pexels.com/photos/898336/pexels-photo-898336.jpeg?cs=srgb&dl=blue-bmw-4-series-898336.jpg&fm=jpg", title: "Skoda Rapid", capacity: "3 + 1 ",rs: '14',createdAt: new Date() },
                { source: "https://images.pexels.com/photos/1035108/pexels-photo-1035108.jpeg?cs=srgb&dl=photography-of-blue-wagon-audi-1035108.jpg&fm=jpg", title: "Hyundai Xcent", capacity: "3 + 1",rs: '12',createdAt: new Date() },
            ],
            bookingList : []
        }
            ...
            <Card key={index} containerStyle={styles.sliderView}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={styles.carsbookings}>
                        ...
                        <View style={{alignSelf:'flex-end',backgroundColor:"#FAD162",paddingHorizontal:10,paddingVertical:2,borderRadius:100}}>
                            <Text style={styles.itemtitlename,{color:"#fff"}}>{item.status[item.status.length-1].value}</Text>
                        </View>     
                    </View>
                    <TouchableOpacity style={styles.viewBookingTickets} onPress={()=>this.props.navigation.navigate('BookingsPageView')}>
                        <Icon name='chevrons-right' size={20} color={'#333'} type='feather'/>
                    </TouchableOpacity>
                 </View>   
            </Card>
        );
