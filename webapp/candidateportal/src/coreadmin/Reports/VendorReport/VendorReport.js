    ...
    constructor(props) {
        ...
        this.state = {
          ...
          tableHeading:{
            ...
            employeeName:"Drivers",
            cars:"Cars",
            bookingNumber:"Allocated Bookings",
            completed:"Completed",
            rejected:"Rejected",
            completed:"Completed",
            cancelled:"Cancelled",
  ...
  getData(event){ 
    ...
    this.setState({reset:false})
      ...
      .then((response) => {
        ...
        var tableData = response.data.map((a, i)=>{
           statusArrayAll.push(a.statusValue);
           statusArray = Array.from(new Set(statusArrayAll))
          if(a.company[0].companyName){
            companyNamesALL.push(a.company[0].companyName);
        ...
        return{
              ComapnyName:a.company[0].companyName,//a.vendor[0] ? a.vendor[0].companyName : 'NA',
              ...
              employeeName:a.person.length ,
              cars:a.person.length ,
              bookingNumber:"-",
              completed:"-",
              rejected:"-",
              cancelled:"-",
