	...
	constructor(props) {
		...
		this.state = {
	        ...
	        tableObjects : {
	          ...
	          searchApply     : false,
	          editUrl         : '/'+this.props.type+'/master',
	          deleteMethod    : 'delete',
    ...
    getDataTable(){
		...
		.then((response)=>{
	        ...
	        return{
	            ...
	            contactDetails: a.email + "<br/> "+a.contactNo  ,
							...
							<div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div className="col-lg-12"> 
								 ...
								 this.state.personList && this.state.personList.length > 0 ?
									<div className="col-lg-5 col-md-5 col-sm-5 col-xs-5 scrollbar" id="style-2">
								...
								this.state.showDetails ?
									<div>
									{
									 this.state.view === 'Grid' && this.state.id && this.state.personList && this.state.personList.length > 0 ?
										<div className="col-lg-7 col-md-7 col-sm-7 col-xs-7 pdcls suppliersOneProfile commonSup" id={this.state.id}>
