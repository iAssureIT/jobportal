...
class PersonDetails extends Component {
			...
			this.setState({
				...
				if(this.state.Documentarray&&this.state.Documentarray.length>0){
					for (let i=0;i<this.state.Documentarray.length;i++){
						if(this.state.Documentarray[i].documentProof.imgUrl.length>0)
						{
				            if(this.state.Documentarray[i].documentProof.status == "Rejected"  || this.state.Documentarray[i].documentProof.status == "New" ){
	...
	editBasicform(event) {
		this.props.history.push("/"+this.props.entityType+"/" + this.props.type + '/master/' + event.currentTarget.getAttribute('data-id'))
	}
	deleteEntity(event) {
	...
	/*changeshowDocumentsButton(showDocumentsButton){
		this.setState({
			showDocumentsButton : showDocumentsButton
		})
		console.log("showDocumentsButton",showDocumentsButton)
	}*/
	render() {
		return (
			this.state.personInfo ?
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding">
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 singleClientDetails noPadding" data-child={this.state.personInfo._id} id={this.state.personInfo._id}>
						{ this.state.type === "driver" && this.state.userRole.indexOf("admin") > -1 ?
						...
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding borderAllED">
					    	<div  className="col-lg-12 col-md-12 col-sm-12 col-xs-12 blueBack ">
					    		...
					    		<div className="col-lg-6 col-md-4 col-sm-4 col-xs-4 noPadding pull-right marginTop12 textAlignCenter colorWhite">Login Credential Created  {this.state.personInfo.userId && this.state.personInfo.userId!=""? <i class="fa fa-check-circle" aria-hidden="true"></i> : <i class="fa fa-times-circle-o " aria-hidden="true"></i>}</div>
						    </div>
						    <div className="col-lg-10 col-lg-offset-2 col-md-10 col-sm-10 col-xs-10 ">
						    	...
						    	<div className="col-lg-1 col-md-2 col-sm-2 col-xs-2 editOptionView textAlignCenter pull-right noPadding">
					  ...
					  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 borderAllED padding20">
					  	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding">
							...
							{this.state.personInfo.type !== "driver" ?
							<div>
								<ul className="col-lg-4 col-md-4 col-sm-4 col-xs-12 noPadding listLI">
							...
							<ul className="col-lg-2 col-md-4 col-sm-4 col-xs-12 noPadding listLI">
								<li><i className="fa fa-user changeColor " aria-hidden="true"></i>&nbsp;&nbsp;<b>Gender</b></li>
								<li className="marginLeft5">
								{ this.state.personInfo.gender ? 
									(this.state.personInfo.gender == "Female" ?
									 <span><i class="fa fa-female faFemale" aria-hidden="true" title="gender"></i>&nbsp;{this.state.personInfo.gender} </span> 
									 :
									 <span><i class="fa fa-male faMale" aria-hidden="true" title="gender"></i>&nbsp;{this.state.personInfo.gender} </span> 
									 ) 
									: "- NA -"}</li>
							</ul>
					  	...
					  	<ul className="col-lg-8 col-md-4 col-sm-4 col-xs-12 noPadding listLI">
								<li><i className="fa fa-envelope changeColor " aria-hidden="true"></i>&nbsp;&nbsp;{this.state.personInfo.email ? this.state.personInfo.email : " -NA- "}</li>
					  ...
					  {this.state.roles && this.state.roles.indexOf("employee") > -1 && this.state.personInfo.entityType !== "vendor" ?
						...
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 borderAllED addMarginTopPM">
							...
							</div>
							{
								this.state.Documentarray.map((docdata, index) => {
									return (
										<div className="col-lg-12 col-md-12 col-sm-12 col-sm-12 noPadding seperaterBorder" key={index}>
											<ul className="col-lg-6 col-md-12 col-sm-12 col-xs-12">
													...
													<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
							        		{
							        			docdata.documentProof.imgUrl.length>0 ?
							        				docdata.documentProof.imgUrl.map((doc,ind)=>{
							        					return (
							        						<div key={ind} className=" col-lg-3 col-md-3 col-sm-12 col-xs-12 NOpadding-left">
