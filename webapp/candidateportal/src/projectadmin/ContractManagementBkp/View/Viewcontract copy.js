                                    ...
                                    <div className="row">
                                        <div id="viewcontract" className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                {/* <h5 className="col-lg-12 col-md-12 col-sm-12 col-xs-12 headersubtitle">Coporate Car Rental Service</h5> */}
                                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <img src="/images/logo.png" className="headerlogo col-lg-6 col-md-6 col-sm-6 col-xs-6" />
                                                    <h5 className="col-lg-6 col-md-6 col-sm-6 col-xs-6 headersubtitle pull-right">Coporate Car Rental Service</h5>
                                                </div>
                                                ...
                                                <div className="greyheaderdiv col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    Coporate Car Rental Service Contract
                                                </div>
                                                ...
                                                {this.state.contractDetails.company && this.state.contractDetails.entity?
                                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 contracttext">
                                                        <p>
                                                            This Coporate Car Rental Service Contract is entered into {moment(this.state.contractDetails.createdAt).format("DD MMM YYYY")},
                                                ...
                                                }
                                                {
                                                    this.state.contractDetails.company ? 
                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
                                                            ...
                                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 marbtm30 form-margin">
                                                                <div className="col-lg-2 col-md-2 col-sm-12 col-xs-12 detailBoxImg" style={{ "backgroundImage": `url(` + (this.state.contractDetails.company.companyLogo ? this.state.contractDetails.company.companyLogo : "/images/logonotfound.jpg") + `)` }}></div>
                                                                <div className="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                    <h5 className="detailtitle">{this.state.contractDetails.company.companyName}</h5>
                                                                    <ul className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
