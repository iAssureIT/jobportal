														...
														}
														{
															this.props.Actioncol ?
																...
																<td className="textAlignCenter">
																	<div>
																		{this.props.editId && this.props.editId === value._id ? null : <button className="btn deleteBtn btn-success" type="button" id={value._id} onClick={this.restoreUser.bind(this)}>Restore User</button>}
																		{"\n"}
