...
class PersonMaster extends Component {
  ...
  submitPerson(event) {
    ...
    console.log("userDetails",userDetails,this.state.listOfEmpID.indexOf(this.state.employeeID) === -1,this.state.listOfEmpID);
    const main = async () => {
      ...
      .then((response) => {
        ...
        swal(this.Capitalize(this.state.pathname) + " Details Updated Successfully");
         if(window.location.pathname == '/my-profile/'+this.state.personID){
           ...
           console.log("re->0",localStorage.getItem("redirectToURL"))
           this.props.history.push(localStorage.getItem("redirectToURL"))
          }
      })
      .catch((error) => {
        ...
        if (event.currentTarget.files) {
            ...
            main().then(formValues => {
                ...
                for (var k = 0; k < formValues.length; k++) {
                    ...
                    console.log("formValues[k].imgUrl",formValues[k].imgUrl)
          ...
          if (this.state.pathname === 'driver') {
            var docarray = response.data.Documentarray;
                ...
                this.setState({
                    ...
                    console.log("DocumentsDetails",this.state.DocumentsDetails)
                });
            ...
            this.setState({
              ...
              .then(results=>{
                ...
                for (var i = 0; i < results.data.results[0].address_components.length; i++) {
                  for (var b = 0; b < results.data.results[0].address_components[i].types.length; b++) {
                      switch (results.data.results[0].address_components[i].types[b]) {
                 ...
                 var lat = results.data.results[0].geometry.location.latitude
                 var lng = results.data.results[0].geometry.location.longitude
                  this.setState({
                    latLng : results.data.results[0].geometry.location,
    ...
    getCategoryData() {
        ...
        .then((response) => {
            ...
            this.setState({
                ...
                vehicalCategory: tableData.vehicalCategory
            })
            console.log("vehicalCategory",this.state.vehicalCategory,tableData);
        })
        .catch((error) => {           
                    ...
                    <form className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12" id="SelectVendor">
                      {this.state.listOfRoles.indexOf("admin") > -1 ?
                        ...
                        <div className="form-margin col-lg-4 col-md-6 col-sm-12 col-xs-12 driver employee" >
                          <div>
                            <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12">{this.state.entityType} <sup className="astrick">*</sup></label>
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
                                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls NOpadding-left driver guest employee person NOpadding-right">
                                        ...
                                        <div id="empCategory">
                                          <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Employee Category <i className="astrick">*</i><a href="#" data-tip data-for='basicInfo4Tooltip' className="pull-right">
                                           ...
                                           <i title=
                                           {
                                            ...
                                            this.state.vehicalsTable.map((vehical,i)=>{
                                                return(
                                                    "Category "+vehical.empCategory+" - "+vehical.vehicalCategory.map((value,i)=>{return(value)})
                                                )
                                            })
                                            :"No vehicals Found"
                                            } 
                                    ...
                                    <div className="form-margin col-lg-9 col-md-12 col-sm-12 col-xs-12  employee guest person NOpadding-left NOpadding-right">
                                        {window.location.pathname == '/my-profile/'+this.state.personID && this.state.changeAppAuth == false && this.props.entityType === "corporate" ?
