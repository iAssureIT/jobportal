			...
			<div className="bodyWrapper col-12">
				<div className="stateWrapper">
					<div className="darjeeling classHover" onClick={e => this.onDistrictClick("Darjeeling","WB")}> 
						...
						<span className="darjeelingNumber mapCountLabel text-center">{this.state.Darjeeling ? this.state.Darjeeling : 0}</span>
					</div>
					<div className="kalimpong classHover" onClick={e => this.onDistrictClick("Kalimpong","WB")}> 
						...
						<span className="kalimpongNumber mapCountLabel text-center">{this.state.Kalimpong ? this.state.Kalimpong : 0}</span>
					</div>
					<div className="jalpaiguri classHover" onClick={e => this.onDistrictClick("Jalpaiguri","WB")}> 
						...
						<span className="jalpaiguriNumber mapCountLabel text-center">{this.state.Jalpaiguri ? this.state.Jalpaiguri : 0}</span>
					</div>
					<div className="alipurduar classHover" onClick={e => this.onDistrictClick("Alipurduar","WB")}> 
						...
						<span className="alipurduarNumber mapCountLabel text-center">{this.state.Alipurduar ? this.state.Alipurduar : 0}</span>
					</div>
					<div className="coochBihar classHover" onClick={e => this.onDistrictClick("CoochBihar","WB")}> 
						...
						<span className="coochBiharNumber mapCountLabel text-center">{this.state.Cooch_Bihar ? this.state.Cooch_Bihar : 0}</span>
					</div>
					<div className="uttarDinajpur classHover" onClick={e => this.onDistrictClick("Uttar_Dinajpur","WB")}> 
						...
						<span className="uttarDinajpurNumber mapCountLabel text-center">{this.state.Uttar_Dinajpur ? this.state.Uttar_Dinajpur : 0}</span>
					</div>
					<div className="dakshinDinajpur classHover" onClick={e => this.onDistrictClick("Dakshin_Dinajpur","WB")}> 
						...
						<span className="dakshinDinajpurNumber mapCountLabel text-center">{this.state.Dakshin_Dinajpur ? this.state.Dakshin_Dinajpur : 0}</span>
					</div>
					<div className="malda classHover" onClick={e => this.onDistrictClick("Malda","WB")}> 
						...
						<span className="maldaNumber mapCountLabel text-center">{this.state.Malda ? this.state.Malda : 0}</span>
					</div>
					<div className="murshidabad classHover" onClick={e => this.onDistrictClick("Murshidabad","WB")}> 
						<img src="/Maps/West_Bengal/Murshidabad.png"  alt="Murshidabad" Malda
						...
						<span className="murshidabadNumber mapCountLabel text-center">{this.state.Murshidabad ? this.state.Murshidabad : 0}</span>
					</div>
					<div className="birbhum classHover" onClick={e => this.onDistrictClick("Birbhum","WB")}> 
						...
						<span className="birbhumNumber mapCountLabel text-center">{this.state.Birbhum ? this.state.Birbhum : 0}</span>
					</div>
					<div className="purbaBardhaman classHover" onClick={e => this.onDistrictClick("Purba_Bardhaman","WB")}> 
						...
						<span className="purbaBardhamanNumber mapCountLabel text-center">{this.state.Purba_Bardhaman ? this.state.Purba_Bardhaman : 0}</span>
					</div>
					<div className="nadia classHover" onClick={e => this.onDistrictClick("Nadia","WB")}> 
						...
						<span className="nadiaNumber mapCountLabel text-center">{this.state.Nadia ? this.state.Nadia : 0}</span>
					</div>
					<div className="pashchimBardhaman classHover" onClick={e => this.onDistrictClick("Pashchim_Bardhaman","WB")}> 
						...
						<span className="pashchimBardhamanNumber mapCountLabel text-center">{this.state.Pashchim_Bardhaman ? this.state.Pashchim_Bardhaman : 0}</span>
					</div>
					<div className="bankura classHover" onClick={e => this.onDistrictClick("Bankura","WB")}> 
						...
						<span className="bankuraNumber mapCountLabel text-center">{this.state.Bankura ? this.state.Bankura : 0}</span>
					</div>
					<div className="parulia classHover" onClick={e => this.onDistrictClick("","WB")}> 
						...
						<span className="paruliaNumber mapCountLabel text-center">{this.state.Parulia ? this.state.Parulia: 0}</span>
					</div>
					<div className="jhargram classHover" onClick={e => this.onDistrictClick("Jhargram","WB")}> 
						...
						<span className="jhargramNumber mapCountLabel text-center">{this.state.Jhargram ? this.state.Jhargram : 0}</span>
					</div>
					<div className="pashchimMedinipur classHover" onClick={e => this.onDistrictClick("Pashchim_Medinipur","WB")}> 
						...
						<span className="pashchimMedinipurNumber mapCountLabel text-center">{this.state.Pashchim_Medinipur ? this.state.Pashchim_Medinipur : 0}</span>
					</div>
					<div className="purbaMedinipur classHover" onClick={e => this.onDistrictClick("Purba_Medinipurnipur","WB")}> 
						...
						<span className="purbaMedinipurNumber mapCountLabel text-center">{this.state.Purba_Medinipur ? this.state.Purba_Medinipur : 0}</span>
					</div>
					<div className="hooghly classHover" onClick={e => this.onDistrictClick("Hooghly","WB")}> 
						...
						<span className="hooghlyNumber mapCountLabel text-center">{this.state.Hooghly ? this.state.Hooghly : 0}</span>
					</div>
					<div className="howrah classHover" onClick={e => this.onDistrictClick("Howrah","WB")}> 
						...
						<span className="howrahNumber mapCountLabel text-center">{this.state.Howrah ? this.state.Howrah : 0}</span>
					</div>
					<div className="north24Paraganas classHover" onClick={e => this.onDistrictClick("North_24_Paraganas","WB")}> 
						...
						<span className="north24ParaganasNumber mapCountLabel text-center">{this.state.North_24_Paraganas ? this.state.North_24_Paraganas : 0}</span>
					</div>
					<div className="south24Paraganas classHover" onClick={e => this.onDistrictClick("South_24_Paraganas","WB")}> 
						...
						<span className="south24ParaganasNumber mapCountLabel text-center">{this.state.South_24_Paraganas ? this.state.South_24_Paraganas : 0}</span>
					</div>
					<div className="kolkata classHover" onClick={e => this.onDistrictClick("Kolkata","WB")}> 
						...
						<span className="kolkataNumber mapCountLabel text-center">{this.state.Kolkata ? this.state.Kolkata : 0}</span>
					</div>
