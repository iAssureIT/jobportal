		...
		return(
			<div className="bodyWrapper col-12">
				<div className="stateWrapper">
					...
					<div className="dimapur classHover" onClick={e => this.onDistrictClick("Dimapur","NL")}> 
					...
					<div className="kohima classHover" onClick={e => this.onDistrictClick("Kohima","NL")}> 
					...
					<div className="phek classHover" onClick={e => this.onDistrictClick("Phek","NL")}> 
					...
					<div className="kiphireSadar classHover" onClick={e => this.onDistrictClick("Kiphire Sadar","NL")}> 
					...
					<div className="zunhebotoSadar classHover" onClick={e => this.onDistrictClick("Zunheboto Sadar","NL")}> 
					...
					<div className="wokhaSadar classHover" onClick={e => this.onDistrictClick("Wokha Sadar","NL")}> 
					...
					<div className="tuensangSadar classHover" onClick={e => this.onDistrictClick("Tuensang Sadar","NL")}> 
					...
					<div className="mokochung classHover" onClick={e => this.onDistrictClick("Mokochung","NL")}> 
					...
					<div className="longleng classHover" onClick={e => this.onDistrictClick("Longleng","NL")}> 
					...
					<div className="mon classHover" onClick={e => this.onDistrictClick("Mon","NL")}> 
