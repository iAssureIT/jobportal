			...
			<div className="bodyWrapper">
				<div className="stateWrapper">
					<div className="Chandigarh classHover" onClick={e => this.onDistrictClick("Chandigarh","LA")}> 
						...
						<span className="ChandigarhNumber mapCountLabel text-center">{this.state.Chandigarh ? this.state.Chandigarh : 0}</span>
					</div>
...
export default connect(mapStateToProps, mapDispatchToProps) (withRouter(Chandigarh));