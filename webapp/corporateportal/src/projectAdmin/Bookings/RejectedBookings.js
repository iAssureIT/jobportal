        ...
        .then((response) => {
            ...
            .then((res) => {
                ...
                this.setState({managerId:managerId})
                    ...
                    axios.get("/api/bookingmaster/get/getAllRejectedBookings/"+managerId)
                    .then((bookingData) => {
                        ...
                        <section className="content">
                            <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                                    <h4 className="weighttitle col-lg-11 col-md-11 col-xs-11 col-sm-11 NOpadding-right"><span className="">Rejected Bookings</span></h4>
                                </div>
