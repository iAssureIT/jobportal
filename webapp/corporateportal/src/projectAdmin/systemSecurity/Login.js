         ...
         axios.defaults.headers.common['Authorization'] = 'Bearer '+response.data.token;
          if (response.data.ID) {
             var  userDetails = {
              ...
              workLocation: response.data.userDetails.workLocation,
                  ...
                  <div className="table-responsive col-lg-12 col-md-12">
                    <table className="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{process.env.REACT_APP_MANAGERID}</td>
                          <td>{process.env.REACT_APP_MANAGERPWD}</td>
                          <td>Manager</td>
                        </tr>
                        <tr>
                          <td>{process.env.REACT_APP_ADMINID}</td>
                          <td>{process.env.REACT_APP_ADMINPWD}</td>
                          <td>Admin</td>
                        </tr>
                      </tbody>
                    </table>
