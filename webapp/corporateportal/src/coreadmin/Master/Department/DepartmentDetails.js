...
class DepartmentDetails extends Component {
    ...
    getData(){
		axios.get("/api/departmentmaster/get/one/"+this.state.id)
        .then((response)=>{
          this.setState({
    ...
    confirmDelete(event){
    	...
    	axios.get("/api/departmentmaster/get/one/"+this.state.deleteID)
        .then((response)=>{
        ...
        .catch((error)=>{
      	...
      	axios.delete("/api/departmentmaster/delete/"+this.state.deleteID)
            .then((response)=>{
