    ...
    this.setState({reset:false})
      ...
      .then((response) => {
        ...
        var tableData = response.data.map((a, i)=>{
          ...
          var cost =  (a.bookings.map((booking,i)=>{return booking.estimatedCost}))
          sum = cost.reduce(function(a, b){
              return a + b;
          }, 0);
          console.log("sum",sum);
          }
          if(a.bookings && a.bookings.length >0 ) {
           statusArrayAll.push(a.profileStatus);
           statusArray = Array.from(new Set(statusArrayAll))
          }
          if(a.companyName){
            companyNamesALL.push(a.companyName);
        ...
        return{
              ...
              ComapnyName:a.companyName +" ("+ a.companyID + ")",//a.vendor[0] ? a.vendor[0].companyName : 'NA',
              ...
              employeeName:a.contactPersons ? a.contactPersons.length : "0" ,
              bookingNumber:a.bookings.length ,
              completed:"-",
              rejected:"-",
              cancelled:"-",
              kmTravelled:"-",
              ...
              <div className="row">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div className="form-margin col-lg-3 col-md-6 col-sm-12 col-xs-12 driver employee" >
                    ...
                    {console.log("companyNames",this.state.companyNames,this.state.stateArrayList)}
                  ...
                  <div className="form-margin col-lg-3 col-md-6 col-sm-12 col-xs-12 driver employee" >
                    ...
                    <select id="corporate" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.corporate} ref="corporate" name="corporate" onChange={this.handleCityChange.bind(this)}>
                      <option selected={true} disabled={true}>{"-- Select --"}</option>
                      {
