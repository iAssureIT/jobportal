...
class Viewcontract extends Component {
        ...
        axios.get("/api/contract/get/one/entity/" + company_Id)
            .then((response) => {
                ...
                this.setState({
                    ...
                    // console.log("packagesByCity = " , packagesByCity);
                    this.setState({
                  ...
                  this.setState({
                    ...
                    if(this.state.entityInfo.updated == true)
                    {
                        ...
                        text: "Corporate Admin Name :"+this.state.userDetails.firstName +" " +this.state.userDetails.lastName+
                                "\nDesignation, Department :"+(this.state.Designation ? this.state.Designation.designation : "-")+" , "+(this.state.Department?this.state.Department.department:"-")+
    ...
    render() {
        ...
        console.log("party1status=>",this.state.party1status);
        return (
                                                ...
                                                <div id="viewcontract" className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <p style={{"textAlign" : "justify"}}>
                                                            This <b> Vendor Car Rental Service Contract </b> is made and entered into this <b>
                                                        ...
                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                                                <div className="signdetails col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">                                                                
                                                                    <div className="col-lg-8 col-md-8 col-sm-8 col-xs-12 NOpadding">
