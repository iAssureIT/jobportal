			...
			if(contacts){
			 var tableData = contacts.map((a, i)=>{			 	
	          return {
	            ...
	            contactDetail     : "Name : "+"<a  title='View profile' href='/employee-profile/"+(a._id)+"'>"+a.firstName + " " + a.lastName+"</a>"+ "</br> Emp Id : "+a.employeeID+"",
	            ...
	            role     					: a.role ? a.role :" - ",
	            approvingauthority1: a.bookingApprovalRequired == "Yes" ? "EmpID : " + a.approvingAuthorityId1  : "- NA -",
	            approvingauthority2: a.bookingApprovalRequired == "Yes" ? "EmpID : " + a.approvingAuthorityId2: "- NA -",
	            approvingauthority3: a.bookingApprovalRequired == "Yes" ? "EmpID : " + a.approvingAuthorityId3: "- NA -",
	            preApprovedAmount: a.bookingApprovalRequired == "Yes" ? a.preApprovedAmount + " | " +a.preApprovedKilometer + " | " +a.preApprovedRides :" - ",
	          }
	        })
	        this.setState({
