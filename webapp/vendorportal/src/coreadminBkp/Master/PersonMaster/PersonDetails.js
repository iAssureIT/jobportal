	...
	getData(id) {
		...
		.then((response) => {
			this.setState({
				...
				console.log("docdata",this.state.Documentarray)
				...
				if(response.data.Documentarray&&response.data.Documentarray.length>0){
			...
			this.state.personInfo ?
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding">
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 singleClientDetails noPadding" data-child={this.state.personInfo._id} id={this.state.personInfo._id}>
						...
						( this.state.showDocumentsButton ?
							<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding">
					  ...
					  {this.state.roles && this.state.roles.indexOf("employee") > -1 ?
