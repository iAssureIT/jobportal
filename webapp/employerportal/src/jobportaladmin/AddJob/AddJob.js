													...
													<div className="col-lg-6">
														<div className="row row-no-gutters">
															<div className="col-lg-8">
																...
																<div className="input-group">
																	<span className="input-group-addon formField">{/*<i className="fa fa-map-marker locationIcon"></i> */}<FontAwesomeIcon className="locationIcon" icon={['fas', 'map-marker-alt']} /></span> 
											...
											<div className="form-group col-lg-12 formFieldRow text-left">
												<div className="row">
													...
													<div className="col-lg-6">
														...
														<div className="input-group">
															<span className="input-group-addon formField"><FontAwesomeIcon icon={['fas', 'briefcase']} /></span> 
											...
											<div className="col-lg-12 formFieldRow text-left">
												<div className="row">
													...
													<div className="col-lg-4">
														...
														<div className="input-group">
															<span className="input-group-addon formField"><FontAwesomeIcon icon={['fas', 'business-time']} /></span> 
