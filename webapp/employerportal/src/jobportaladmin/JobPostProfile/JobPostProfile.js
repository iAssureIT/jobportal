	...
	componentDidMount(){
		...
		Axios.get("/api/jobposting/get/one/"+job_id)
			.then(response=>{
				...
				console.log("response.data from job profile = ",response.data[0]);

				this.setState({
					job_id			: job_id,
					jobTitle 		: response.data[0].jobBasicInfo.jobTitle,
					jobLocationCity : response.data[0].jobBasicInfo.jobLocationCity,
					country 		: response.data[0].jobBasicInfo.country,
					functionalArea 	: response.data[0].jobBasicInfo.functionalArea,
					role 			: response.data[0].jobBasicInfo.role,
					gender 			: response.data[0].jobBasicInfo.gender,
					/*workFromHome 	: response.data[0].workFromHome,
					jobType 		: response.data[0].jobType,*/
					minSalary 		: response.data[0].ctcOffered.minSalary,
					minSalPeriod 	: response.data[0].ctcOffered.minSalPeriod,
					maxSalary 		: response.data[0].ctcOffered.maxSalary,
					maxSalPeriod	: response.data[0].ctcOffered.maxSalPeriod,
					jobDesc 		: response.data[0].jobBasicInfo.jobDesc,
					minEducation 	: response.data[0].eligibility.minEducation,
					minExperience 	: response.data[0].eligibility.minExperience,
					minPrimExp 		: response.data[0].requiredSkills.minPrimExp,
					minSecExp 		: response.data[0].requiredSkills.minSecExp,
					minOtherExp 	: response.data[0].requiredSkills.minOtherExp,
                })
