...
class ApprovedBookings extends Component {
       ...
       var userId = localStorage.getItem("user_ID");
        ...
        .then((response) => {
            ...
            .then((res) => {
                ...
                // var formvalue={
                // status:["Manager Approved","Edited Manager Approved"],
                // managerId:this.state.managerId
                //     }
                     axios.get("/api/bookingmaster/get/getAllApprovedBookings/"+managerId)
                    .then((bookingData) => {
                        this.setState({'bookingData':bookingData.data,
                            showDetails:true,
                            showEditForm:false,
                            bookingCount:bookingData.data.length,
                            id:bookingData.data[0]._id,
                            bookingNumber:bookingData.data[0].bookingId,
                            empID :bookingData.data[0].employeeId,
                            estimatedCost :bookingData.data[0].estimatedCost,
                            status :bookingData.data[0].statusValue,
                            managerID:bookingData.data[0].managerID1,
                            approvalRequired:bookingData.data[0].approvalRequired,
                            bookingDate:moment(bookingData.data[0].createdAt).format('DD/MM/YYYY') },()=>{  
                        ...
                        if(bookingData.data[0] && this.state.view == 'Grid'){
                        document.getElementById(bookingData.data[0]._id).classList.add("selectedBooking")
                        }
                        console.log('bookingData.data==>',bookingData.data)
                 //Grid View//
              var tableData = bookingData.data.map((a, i)=>{
                var status = "";
    ...
    ShowForm(event) {
        ...
        this.setState({ id: data,
                        ...
                        managerID:managerID,approvalRequired:approvalRequired });
                        ...
                        <section className="content">
                            <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                                    <h4 className="weighttitle col-lg-11 col-md-11 col-xs-11 col-sm-11 NOpadding-right"><span className="">Approved Bookings</span></h4>
                                </div>
