		...
		return (
	       	<div id="tableComponent" className="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				{this.state.tableObjects.paginationApply === true ?
					<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 paddingLeftCss noPadding">
											...
											return(
												<tr key={i} className="">
													...
													}
													{
														...
														<button type="button" className="btn btn-primary" title="Tracking"  onClick={()=>window.open('tracking/'+value.id, "_blank")}><b>Tracking</b></button>
														:
														"NA"
														}
															
															<div id="myModal" className="modal col-lg-12" role="dialog">
															  <div className="modal-dialog">
															    ...
															    <div className="modal-content">
															      ...
															      <div className="modal-body">
                                                        				<label className="labelform textAlignLeft col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Reason of Rejection <i className="astrick">*</i></label>
															       		<textarea  rows="4" cols="90" placeholder="Reason">
															       		</textarea>
															      </div>
