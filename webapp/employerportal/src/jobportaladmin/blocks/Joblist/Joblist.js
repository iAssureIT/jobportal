				...
				<div className="col-lg-12 EmployeeListWrapperMain">
					...
					<div className="col-lg-8 col-lg-offset-2 row btnsRow">
						<ul className="nav nav-pills nav-justified">
						  	<li className="active col-lg-4 row"  onClick={this.changeStatus.bind(this, "active")}  ><a data-toggle="pill" href="#activejobs"  >Active Jobs</a></li>
						  	<li className="col-lg-4 row"  onClick={this.changeStatus.bind(this,"inactive")}><a data-toggle="pill" href="#inactivejobs" >Inactive Jobs</a></li>
						  	<li className="col-lg-4 row"  onClick={this.changeStatus.bind(this,"draft")}><a data-toggle="pill" href="#draftjobs" >Drafts Jobs</a></li>
						</ul>
					</div>	
