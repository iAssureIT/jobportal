...
class CorporateReport extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
          ...
          tableHeading:{
            ...
            pendingBillAmount:"Pending Bill Amount",
            settledBillAmount:"Settled Bill Amount",
  ...
  changeTab(value,event){
   ...
   getBookingData(selector){
    var formValues ={
        ...
        axios.post('/api/reports/get/corporateReportsfilter',formValues)
      .then((response) => {
        var tableData = response.data.map((a, i)=>{
          function onlyUnique(value, index, self) { 
            ...
            return{
                  ...
                  pendingBillAmount:a.pendingBillAmount,
                  settledBillAmount:a.settledBillAmount,
            }
        })
        ...
        <section className="content">   
          <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding">
              <h4 className="weighttitle col-lg-5 col-md-11 col-xs-11 col-sm-11">Corporate Report</h4>
            </div>
            <section className="Content">
              <div className="row">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div className="form-margin col-lg-3 col-md-6 col-sm-12 col-xs-12 driver employee" >
                    ...
                    <select onChange={this.handleCityChange.bind(this)} value={this.state.bookingStatus} id="bookingStatus" ref="bookingStatus" name="bookingStatus" className="form-control">
