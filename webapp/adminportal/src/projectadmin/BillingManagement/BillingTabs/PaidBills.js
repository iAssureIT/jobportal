...
class PaidBills extends Component {
   constructor(props){
      ...
      this.viewSinglePaidInvoice = this.viewSinglePaidInvoice.bind(this);
    ...
    componentDidMount(){
        ...
        window.viewSinglePaidInvoice = this.viewSinglePaidInvoice;
        this.getAllPaidInvoices(this.state.startRange, this.state.limitRange);
        this.getCompany();
        this.getDepartment();
        this.setState({
            user_ID      : user_ID,
    ...
    /*======== viewSinglePaidInvoice() ========*/
    viewSinglePaidInvoice(id){
        console.log("view id = ", id);
        this.props.history.push('/view-invoice/'+id)
    }

    /*======== getAllPaidInvoices() ========*/
    getAllPaidInvoices(startRange, limitRange){
        var limits = {
            startRange : startRange,
            limitRange : limitRange
        }
        axios.post('/api/billing/get/allPaidList',limits)
        .then((response)=>{
                ...
                var tableData = response.data[0].paginatedResults.map((a, i)=>{ 
                    ...
                    return{ 
                        ...
                        invoiceNumber   : "<div class=invoiceNumCol>"+
                                             "<a class='masterInvoiceNum' aria-hidden='true' title='click to view' id='" + a._id + "' onclick=window.viewSinglePaidInvoice('" +a._id +"')>" + a.invoiceNumber + 
                                           "</a></div>",
                        ...
                        action          : "<div class='actionButtons invoiceAction'>"+
                                                ...
                                                "<a aria-hidden='true' title='click to view' id='" + a._id + "' onclick=window.viewSinglePaidInvoice('" +a._id +"')><i class='fa fa-eye'></i></a>"+
                                           "</div>",
                        id              : a._id
                    }
        ...
        .catch((err)=>{
            console.log("Error getAllPaidInvoices() => ", err);
        })
    }
    ...
    showMoreFilters(event){
        ...
        var element   = document.getElementById("allPaidBillsMoreFilter");
        
        if (element) {
            $("#allPaidBillsMoreFilter").toggle();
        }
    ...
    showData(startRange, limitRange){
        if (this.state.company || this.state.search ||
            ...
            this.getAllPaidInvoices(startRange, limitRange);
            console.log("normal");
        }
    } 
   ...
   render() {
      return (         
         <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding tableComponent">
            ...
            <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding generateBillMoreFilter" id="allPaidBillsMoreFilter"> 
                <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding mrgTop1">                              
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12">
...
export default withRouter(PaidBills);