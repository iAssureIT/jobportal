    ...
    getContract() {
        axios.get("/api/contract/get/joincontract/" + this.props.match.params.contractID)
            .then((response) => {
                ...
                console.log("entity location array => ", response.data[0].entity.locations);
                console.log("entity location id => ", response.data[0].entityLocationId);
                console.log("filtered entity location array => ", (response.data[0].entity.locations.filter((a, i) => response.data[0].entityLocationId.includes(a._id))));
                ...
                console.log("company location array => ", response.data[0].company.locations);
                console.log("company location id => ", response.data[0].companyLocationId);
                console.log("filtered company location array => ", (response.data[0].company.locations.filter((a, i) => response.data[0].companyLocationId.includes(a._id))));
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <section className="content">
                            <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div className="box-header with-border col-lg-12 col-md-12 col-xs-10 col-sm-10 NOpadding-right"></div>
                                <section className="Content">
                                    <div className="row">
                                                        ...
                                                        <p style={{"textAlign" : "justify"}}>
                                                            ...
                                                            ?
                                                                <span>
                                                                    ...
                                                                    {this.state.contractDetails.company.location.country ? this.state.contractDetails.company.location.country : ""}</i> and &nbsp;
                                                                    </span>
                                                            :
                                                                null
                                                            }
                                    ...
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <button className="button2 btn margBtm40" onClick={this.back.bind(this)}><i className="fa fa-angle-double-left" aria-hidden="true"></i>&nbsp;Conditions</button>
                                            <button className="button1 pull-right btn" onClick={this.finish.bind(this)}>Finish&nbsp;</button>
                                        </div>
                                    </div>
                                </section>
                            </div>
