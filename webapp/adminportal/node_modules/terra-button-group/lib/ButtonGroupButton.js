...
var ButtonGroupButton = /*#__PURE__*/function (_React$Component) {
  _inherits(ButtonGroupButton, _React$Component);

  var _super = _createSuper(ButtonGroupButton);
  ...
  _createClass(ButtonGroupButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          customProps = _objectWithoutProperties(_this$props, ["icon", "isDisabled", "onFocus"]);

      var theme = this.context;
      var buttonClassName = (0, _classnames.default)(cx('button-group-button', {
        'is-disabled': isDisabled
      }, {
        'is-focused': this.state.focused && !isDisabled
      }, theme.className), customProps.className);
      return /*#__PURE__*/_react.default.createElement(_terraButton.default, _extends({}, customProps, {
        icon: icon,
...
ButtonGroupButton.contextType = _terraThemeContext.default;
var _default = ButtonGroupButton;
